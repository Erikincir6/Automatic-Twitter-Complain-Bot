...
class InternetSpeedTwitterBot:
    def __init__(self, driver_path):
        chrome_service = fs.Service(executable_path="C:/Development/chromedriver.exe")
    ...
    def get_internet_speed(self):
        ...
        time.sleep(3)
        speed_check = self.driver.find_element(By.CLASS_NAME, "start-text")
        speed_check.click()
    ...
    def tweet_at_provider(self):
        ...
        time.sleep(2)
        email = self.driver.find_elemen(By.XPATH,
